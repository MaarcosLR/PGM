...
<<<<<<< HEAD
            ...
            if (response.redirected) {
                ...
                // Después de cerrar el modal, redirige a la url que manda el backend
                window.location.href = response.url;
            } else {
                await window.mostrarMensaje('Sesión cerrada.');
                // Aquí podrías hacer otra acción si no hay redirección
...
>>>>>>> parent of e7de919 (- Modal principal revertido)
    ...
    try {
        ...
        async function agregarListenersModeracion() {
